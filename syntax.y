...
%token IF ELSE FOR WHILE DO VOID SWITCH DEFAULT GOTO BREAK CHAR DOUBLE RETURN CASE CONTINUE PRINTLN CONST_INT CONST_FLOAT ADDOP MULOP INCOP DECOP RELOP ASSIGNOP LOGICOP NOT LPAREN RPAREN COMMA LCURL RCURL LTHIRD RTHIRD COLON SEMICOLON ID INT FLOAT
